...
def customer(customer_id):
  ...
  return render_template('customer.html', title=customer.details, customer=customer, debt=debt, lm_month=lm_month, lm_year=lm_year, lm_debt=lm_debt)
...
def update_interaction(interaction_id):
  ...
  if form.validate_on_submit():
    ...
    db.session.commit()
    flash('Dane interakcji zmienione!', 'success')
  ...
  return render_template('add_interaction.html', title='Zmiana interakcji',
                         form=form, legend='Update interakcji')
...
def add_interaction(customer_id):
  ...
  return render_template('add_interaction.html', title='Nowa interakcja',
                         form=form, legend='Nowa interakcja')
